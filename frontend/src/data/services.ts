    ...
    services: [
      {
        ...
        description: [
                  'Identify vulnerabilities and reduce security risks'
                ],
        icon: Search,
      },
      {
      ...
      },
      {
        ...
        description: "ZTNA verifies every user and device, ensuring secure access without VPNs.",
        icon: Network,
      },
    ],
  },
    ...
    services: [
      {
        ...
        description: "We build and test secure, reliable smart contracts to ensure flawless execution.",
        icon: FileCog,
      },
      {
        name: "Infrastructure Security",
        description: "Protect consensus mechanisms, nodes, and networks from attacks like 51% exploits and double-spending.",
        icon: FileCog,
      },
      {
        name: "Transaction Security",
        description: "Ensure transaction integrity, prevent manipulation, and secure user assets.",
        icon: FileCog,
      },
      {
        name: "DeFi Security Solutions",
        description: "Mitigate risks in decentralized finance platforms through code audits, penetration testing, and monitoring.",
        icon: FileCog,
      },
      {
        name: "NFT Security",
        description: "Safeguard NFT platforms against fraud, unauthorized access, and data tampering.",
        icon: FileCog,
      },
      {
        name: "Incident Response & Recovery",
        description: "Quickly detect and respond to blockchain-related breaches or anomalies.",
        icon: FileCog,
      },
      {
        name: "Compliance & Risk Management",
        description: "Align blockchain systems with security best practices and legal requirements.",
        icon: FileCog,
      },
    ...
    services: [
      {
        ...
        description: "We turn raw data into actionable insights using analytics, visualization, and AI.",
        icon:  HardDriveDownload,
      },
      {
        name: "Data Security & Compliance",
        description: "We protect sensitive data and ensure compliance with standards like GDPR, HIPAA, and ISO 27001.",
        icon: DatabaseBackup,
      },
      {
        name: "Big Data Processing",
        description: "We turn big data into business growth through ETL, predictive modeling, and real-time analytics.",
        icon:  DatabaseZap,
      },
    ...
    services: [
      {
        ...
        description: "We use voter data to build predictive models that guide impactful campaign decisions.",
        icon: Layout,
      },
      {
    ...
    services: [
      {
        ...
        description: "Use machine learning to find patterns, trends, and insights in data.",
        icon: FileChartPie,
      },
      {
        name: "Generative AI Solutions",
        description: "Use generative AI to create content, automate tasks, and improve decisions.",
        icon: Cpu,
      },
      {
      ...
      },
     {
        ...
        description: "Use AI predictive models to forecast trends, behavior, and outcomes.",
        icon: Volleyball,
      },
      {
        name: "AI-Driven Personalization",
        description: "Deliver personalized content, recommendations, and experiences.",
        icon: Volleyball,
      },
    ...
    services: [
      {
        ...
        description: "Create tailored strategies to boost reach, engagement, and conversions.",
        icon: Lightbulb,
      },
      {
        name: "Content Creation",
        description: "Design and produce optimized posts, graphics, and videos.",
        icon: SquarePen,
      },
      {
      ...
      },
      {
        ...
        description: "Run targeted, data-driven social campaigns for leaders and parties.",
        icon: UserCog,
      },
