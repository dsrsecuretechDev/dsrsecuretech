...
import { APP_NAME, COPY_RIGHTS } from "../../constant/global-key.const";
      ...
      case "linkedin":
        return (
          <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
           ...
           2.24 5 5 5h14c2.76 0 5-2.24 5-5v-14c0-2.76-2.24-5-5-5zm-11.25 
           20h-2.5v-10h2.5v10zm-1.25-11.25c-.83 
           0-1.5-.67-1.5-1.5s.67-1.5 
           1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 
           1.5zm13.25 11.25h-2.5v-5.5c0-1.38-.56-2-1.5-2s-1.5.62-1.5 
           2v5.5h-2.5v-10h2.5v1.5c.45-.83 1.39-1.5 2.5-1.5 
           2.21 0 3.5 1.5 3.5 4.5v5.5z"
              clipRule="evenodd"
            />
          </svg>
        );
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Transform Your Enterprise with Secure and Scalable Business
              Solutions.
            </p>
