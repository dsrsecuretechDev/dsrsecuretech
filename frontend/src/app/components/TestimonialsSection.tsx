      ...
      <div className="section-container">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            ...
            <span className="gradient-text">Your Trust</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <div
              ...
              className="bg-gradient-to-b from-saas-darkGray to-saas-black border border-gray-800 rounded-xl p-6 card-shadow transform transition-transform duration-300 hover:scale-105 hover:shadow-xl hover:border-saas-orange"
            >
              ...
              <div className="flex items-center">
                ...
                />
                <div>
                  <p className="font-semibold text-saas-orange">
                    {testimonial.author}
                  </p>
